...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
      ...
      <a class="navbar-brand" href="${contextPath}/index.jsp">JudgedBy</a>
      ...
      <div class="collapse navbar-collapse" id="navbar">
        ...
        <ul class="navbar-nav mr-auto">
          ...
          <li class="nav-item active">
            ...
            <a class="nav-link" href="${contextPath}/index.jsp">메인</a>
          ...
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="dropdown">
              ...
              <a class="dropdown-item" href="${contextPath}/userLogin.jsp">로그인</a>

              <a class="dropdown-item" href="${contextPath}/register.jsp">회원가입</a>

              <a class="dropdown-item" href="${contextPath}/userLogout.jsp">로그아웃</a>
    ...
    <footer class="bg-dark mt-4 p-5 text-center" style="color: #FFFFFF;">
      ...
      Copyright ⓒ 2023 강현우 All Rights Reserved.
